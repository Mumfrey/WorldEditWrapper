...
public class Reflection
{
	...
	/**
	 * Set a private value on the specified object
	 * 
	 ...
	 */
	public static void setPrivateValue(Class<?> instanceClass, Object instance, String fieldName, String obfuscatedFieldName, String seargeName, Object value) throws IllegalArgumentException, SecurityException, NoSuchFieldException
	{
		Reflection.setPrivateValueRaw(instanceClass, instance, ModUtilities.getObfuscatedFieldName(fieldName, obfuscatedFieldName, seargeName), value);
	}
	...
	/**
	 *Get a private value from the specified object
	 * 
	 * @param instanceClass Class which the member belongs to (may be a superclass of the actual instance object's class)
	...
	public static <T> T getPrivateValue(Class<?> instanceClass, Object instance, String fieldName, String obfuscatedFieldName, String seargeName) throws IllegalArgumentException, SecurityException, NoSuchFieldException
	{
		return (T)Reflection.getPrivateValueRaw(instanceClass, instance, ModUtilities.getObfuscatedFieldName(fieldName, obfuscatedFieldName, seargeName));
	}
